...
from arm_cross_correlation import quaternion_to_euler, read_euler_angles, read_kinematic_data
...
if __name__ == '__main__':
    ...
    time_kin, arm_add = read_kinematic_data('arm_add_l', participant_id, session_id)
    ...
    # Optimise lag
    lag_sec, corr, lags, common_t, xi, yi = optimise_lag(time, pitch_diff, time_kin, arm_add, lb, ub)
